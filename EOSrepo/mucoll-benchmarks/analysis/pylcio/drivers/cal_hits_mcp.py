...
from drivers.utils import get_oldest_mcp_parent
...
class CalHitsMCPDriver(Driver):
    ...
    def __init__(self, output_path='output_py.root'):
        """Constructor"""
    ...
    def processEvent(self, event):
        ...
        for iCol, col_name in enumerate(self.HIT_COLLECTION_NAMES):
            ...
            for iHit in range(nHits):
                ...
                # Decoding the CellID
                cellId = int(hit.getCellID0() & 0xFFFFFFFF) | (
                    int(hit.getCellID1()) << 32
                )
                ...
                for iC in range(nC):
                    ...
                    for prefix, part in {"mcp": mcp, "mcp_bib": mcp_bib}.items():
                        ...
                        data[prefix + "_vtx_r"][0] = math.sqrt(
