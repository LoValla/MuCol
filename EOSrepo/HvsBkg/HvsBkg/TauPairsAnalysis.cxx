...
void HistoMCFiller(const TString &filename, const TString &rootfilename,
  ...
  // --- Histograms initialization
  {
    ...
    h_mcDeltaR = new TH1F(
        "h_mcDeltaR",
        boson + "#rightarrow#tau#tau MC #DeltaR between the taus; #DeltaR", 20,
        0., 4.5);
...
void TauPairsAnalysis(
    ...
    const TString filenameZ = "/eos/user/l/lvalla/MuColl/Z2tautau10k/"
                              "output_EvalTauFinder.root",
    const TString filenameMuMu = "/eos/user/l/lvalla/MuColl/TauTauMuMu/"
                              "output_EvalTauFinder.root",
    const TString rootfilename =
        "/eos/user/l/lvalla/MuColl/HvsZ/HvsAll_Histograms.root") {
  TFile *rootfile = new TFile(rootfilename, "RECREATE");
  rootfile->Close();

  HistoMCFiller(filenameH, rootfilename, "H");
  HistoMCFiller(filenameZ, rootfilename, "Z");
  HistoMCFiller(filenameMuMu, rootfilename, "MuMu");
  ...
  bool corrections = true;
  {
    ...
    HistoRecoFiller(filenameZ, rootfilename, "all", "all", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "mu", "mu", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "e", "e", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "e", "mu", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "e", "1pi", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "1pi", "1pi", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "1pi", "3pi", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "3pi", "3pi", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "had", "had", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "had", "e", "Z", corrections);
    HistoRecoFiller(filenameZ, rootfilename, "hade", "hade", "Z", corrections);
    /*HistoRecoFiller(filenameZ, rootfilename, "e", "1pi0N", "Z",
    corrections); HistoRecoFiller(filenameZ, rootfilename, "e", "1pi1N", "Z",
    corrections); HistoRecoFiller(filenameZ, rootfilename, "e", "1pi2N", "Z",
    corrections); HistoRecoFiller(filenameZ, rootfilename, "e", "1pi3N", "Z",
    corrections);*/

    HistoRecoFiller(filenameMuMu, rootfilename, "all", "all", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "mu", "mu", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "e", "e", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "e", "mu", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "e", "1pi", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "1pi", "1pi", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "1pi", "3pi", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "3pi", "3pi", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "had", "had", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "had", "e", "MuMu", corrections);
    HistoRecoFiller(filenameMuMu, rootfilename, "hade", "hade", "MuMu", corrections);
  }
}